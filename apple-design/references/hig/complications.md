...
> Platforms: watchOS
> Last changed: 2023-10-24 — Replaced links to deprecated ClockKit documentation with links to WidgetKit documentation.
...
Starting in watchOS 9, the system organizes complications (also known as *accessories*) into several families — like [circular](complications.md#circular) and [inline](complications.md#inline) — and defines some recommended layouts you can use to display your complication data. A watch face can specify the family it supports in each complication slot. Complications that work in earlier versions of watchOS can use the [legacy templates](complications.md#legacy-templates), which define nongraphic complication styles that don’t take on a wearer’s selected color.
