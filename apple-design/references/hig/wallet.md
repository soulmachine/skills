...
> Last changed: 2026-06-08 — Updated to reflect guidance for iOS 27 and the Pass Designer app.
...
✓ *Sufficient contrast between a solid background and label text*  ✗ *Insufficient contrast between a solid background and label text*

✓ *Sufficient contrast between an image background and label text*  ✗ *Insufficient contrast between an image background and label text*
