...
If you provide [pop-up buttons](pop-up-buttons.md) or [pull-down buttons](pull-down-buttons.md) that reveal a menu in your iPad app, the menu automatically takes on a macOS appearance in the Mac app you create with Mac Catalyst.
