...
> Last changed: 2026-06-08 — Refined guidance to reflect the latest Apple Pay appearance and capabilities.
...
| Continue with Apple Pay button | An app or website offering a shopping cart or purchase experience that includes other payment buttons that start with the text *Continue*. |
