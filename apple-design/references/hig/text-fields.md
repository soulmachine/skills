...
**Consider using an expansion tooltip to show the full version of clipped or truncated text.** An expansion tooltip behaves like a regular [tooltip](offering-help.md#macos-visionos) and appears when someone places the pointer over the field.
