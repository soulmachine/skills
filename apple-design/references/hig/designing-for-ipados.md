...
**Inputs.** People can interact with iPad using Multi-Touch [gestures](gestures.md) and [virtual keyboards](virtual-keyboards.md), an attached [keyboard](keyboards.md) or [pointing device](pointing-devices.md), [Apple Pencil](apple-pencil-and-scribble.md), or [voice](siri.md), and they often combine multiple input modes.
