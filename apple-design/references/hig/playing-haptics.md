...
> Last changed: 2024-05-07 — Added guidance for playing haptics on Apple Pencil Pro.
...
- When it makes sense, use a feedback generator to play one of several predefined haptic patterns in the categories of [notification](playing-haptics.md#notification), [impact](playing-haptics.md#impact), and [selection](playing-haptics.md#selection) (for developer guidance, see [UIFeedbackGenerator](https://developer.apple.com/documentation/uikit/uifeedbackgenerator)).
